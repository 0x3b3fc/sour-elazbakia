...
?>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        $bookTitle = filter_var($_POST['bookTitle'], FILTER_SANITIZE_ENCODED);
        $bookAuthor = filter_var($_POST['authorName'], FILTER_SANITIZE_ENCODED);
        $bookCat = filter_var($_POST['bookCat'], FILTER_SANITIZE_ENCODED);
        $bookContent = filter_var($_POST['bookContent'], FILTER_SANITIZE_ENCODED);
        // Book Cover
