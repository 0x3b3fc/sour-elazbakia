...
?>
    ...
    <div class="container-fluid">
        ...
        <?php
        if (isset($_POST['edit'])) {
            $adminName = filter_var($_POST['adminName'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
            $adminEmail = filter_var($_POST['adminEmail'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
            $adminPass = filter_var($_POST['adminPass'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
